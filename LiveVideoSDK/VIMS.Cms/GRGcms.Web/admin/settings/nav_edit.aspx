<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="nav_edit.aspx.cs" Inherits="GRGcms.Web.admin.settings.nav_edit" ValidateRequest="false" %>
...
<body class="mainbody">
    <form id="form1" runat="server">
        ...
        <div class="location">
            ...
            <a href="nav_list.aspx"><span>功能菜单</span></a>
            <i class="arrow iconfont icon-arrow-right"></i>
            <span>编辑功能菜单</span>
        </div>
        ...
        <div class="tab-content">
            ...
            <dl>
                ...
                <dd>
                    ...
                    <span class="Validform_checktip">非必填，当菜单拥有两个名称时使用</span>
                </dd>
            </dl>
            <dl>
                <dt>菜单类型</dt>
                <dd>
                    <div class="rule-single-select">
                        <asp:DropDownList ID="ddtType" runat="server" datatype="*" errormsg="请选择菜单类型" sucmsg=" ">
                            <asp:ListItem Selected="True" Value="System">System</asp:ListItem>
