...
namespace GRGcms.Common
{
    public class DTKeys
    {
        ...
        /// 站点配置
        /// </summary>
        public const string CACHE_SYS_CONFIG = "cms_cache_sys_config";
        /// <summary>
        /// 用户配置
        /// </summary>
        ...
        /// 站点所有频道键值对
        /// </summary>
        public const string CACHE_SITE_CHANNEL_LIST = "cms_cache_site_channel_list";
        /// <summary>
        /// 升级通知
        /// </summary>
        public const string CACHE_OFFICIAL_UPGRADE = "cms_official_upgrade";
        /// <summary>
        /// 官方消息
        /// </summary>
        public const string CACHE_OFFICIAL_NOTICE = "cms_official_notice";
