<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="manager_log.aspx.cs" Inherits="GRGcms.Web.admin.manager.manager_log" ValidateRequest="false" %>
            ...
            <div class="toolbar">
                <div class="box-wrap">
                    ...
                    <div class="l-list">
                        <ul class="icon-list">
                            <li>
                                <asp:LinkButton ID="btnDelete" runat="server" OnClientClick="return ExeNoCheckPostBack('btnDelete','删除7天前的管理日志，你确定吗？');" OnClick="btnDelete_Click"><i class="iconfont icon-delete"></i><span>删除日志</span></asp:LinkButton></li>
                        </ul>
                        <div class="menu-list">
        ...
        <div class="table-container">
            <asp:Repeater ID="rptList" runat="server">
                ...
                <ItemTemplate>
                    <tr>
                        <td align="center">
                            <a href="manager_log.aspx?keywords=<%# Eval("account") %>"><%# Eval("account")%></a>
                        </td>
                        <td align="center">
                            <a href="manager_log.aspx?keywords=<%# Eval("eventName") %>"><%# Eval("eventName") %></a>
                        </td>
                        <td><%# Eval("remark") %></td>
                        <td><%# Eval("user_ip") %></td>
