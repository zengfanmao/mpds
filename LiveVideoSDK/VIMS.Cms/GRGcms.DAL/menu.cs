...
namespace GRGcms.DAL
{
    ...
    public partial class menu
    {
        ...
        public bool Exists(int id)
        {
            ...
            strSql.Append("select count(1) from  " + databaseprefix + "menu");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from " + databaseprefix + "menu ");
            strSql.Append(" where id=@id");
            MySqlParameter[] parameters = {
					new MySqlParameter("@id", MySqlDbType.Int32,4)};
            parameters[0].Value = id;
        ...
        public Model.menu GetModel(int id)
        {
            ...
            strSql.Append(" from " + databaseprefix + "menu");
            strSql.Append(" where id=@id");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select * FROM " + databaseprefix + "menu");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
            }
        ...
        /// 得到一个对象实体
        /// </summary>
        public Model.menu GetModel(string nav_name)
        {
            StringBuilder strSql = new StringBuilder();
            StringBuilder str1 = new StringBuilder();
            Model.menu model = new Model.menu();
        ...
        /// 得到一个对象实体，带事务
        /// </summary>
        public Model.menu GetModel(MySqlConnection conn, MySqlTransaction trans, string nav_name)
        {
            StringBuilder strSql = new StringBuilder();
            StringBuilder str1 = new StringBuilder();
            Model.menu model = new Model.menu();
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select id from " + databaseprefix + "menu");
            strSql.Append(" where name=@nav_name");
            strSql.Append(" limit 1");
            MySqlParameter[] parameters = {
					new MySqlParameter("@nav_name", MySqlDbType.VarChar,50)};
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select id,parent_id from " + databaseprefix + "menu");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update " + databaseprefix + "menu set name=@new_name");
        ...
        public int Add(string parent_name, string nav_name, string title, string link_url, int sort_id, int channel_id, string action_type)
        {
            ...
            strSql1.Append("select id from " + databaseprefix + "menu");
            ...
            MySqlParameter[] parameters = {
                    ...
                    new MySqlParameter("@is_lock", MySqlDbType.Int32,1),
					new MySqlParameter("@is_sys", MySqlDbType.Int32,1)};
            parameters[0].Value = parent_id;
