<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="GRGcms.Web.admin.index" %>
...
<form id="form1" runat="server">
  ...
  <div class="main-top">
    ...
    <div class="nav-right">
      <div class="info">
        <h4>
          <%if (!string.IsNullOrEmpty(admin_info.uHeadPortrait)){%>
          <img src="<%=admin_info.uHeadPortrait%>" />
          <%}else{%>
          <i class="iconfont icon-user"></i>
          <%}%>
        </h4>
        <span>
          您好，<%=admin_info.uCode%><br />
          <%=new GRGcms.BLL.role().GetTitle(admin_info.roleid) %>
        </span>
      </div>
      <div class="option">
        ...
        <div class="drop-wrap">
          <ul class="item">
            <li>
              <a href="center.aspx" target="mainframe">管理首页</a>
            </li>
            <li>
