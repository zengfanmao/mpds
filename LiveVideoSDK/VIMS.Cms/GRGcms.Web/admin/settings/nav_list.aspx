<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="nav_list.aspx.cs" Inherits="GRGcms.Web.admin.settings.nav_list" ValidateRequest="false" %>
                ...
                <div class="box-wrap">
                    ...
                    <div class="l-list">
                        <ul class="icon-list">
                            ...
                            <li>
                                <asp:LinkButton ID="btnDelete" runat="server" OnClientClick="return ExePostBack('btnDelete','本操作会删除本导航及下属子导航，是否继续？');" OnClick="btnDelete_Click"><i class="iconfont icon-delete"></i><span>删除</span></asp:LinkButton></li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="table-container">
            <div class="tree-list">
                <div class="thead">
                    ...
                    <div class="col col-3">菜单功能</div>
                    <div class="col col-2">权限标识</div>
                    <div class="col col-4">菜单类型</div>
                    <div class="col col-4">启用</div>
                        ...
                        <ItemTemplate>
                            <li class="layer-<%#Eval("class_layer")%>">
                                <div class="tbody">
                                    ...
                                    <div class="col col-4">
                                        <%#Convert.ToInt32(Eval("is_lock")) == 0 ? "启用" : "禁用"%>
                                    </div>
