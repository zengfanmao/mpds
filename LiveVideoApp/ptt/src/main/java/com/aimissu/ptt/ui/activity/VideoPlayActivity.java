...
public class VideoPlayActivity extends BaseMvpActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(intent!=null){
          String msgData=      intent.getStringExtra(IMType.Params.MSG_DATA);
          if(!TextUtils.isEmpty(msgData)){
              VideoModel videoModel= JsonUtils.toModel(msgData,VideoModel.class);
              if(videoModel!=null){
                  url=videoModel.VideoUrl;
//                  Glide.with(this).load(videoModel.ShowPicutre)
//                          .into(imageView);
              }
          }
        }
