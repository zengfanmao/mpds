<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="manager_pwd.aspx.cs" Inherits="GRGcms.Web.admin.manager.manager_pwd" ValidateRequest="false" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="tab-content">
            <dl>
                <dt>用户名</dt>
                <dd>
                    <asp:TextBox ID="txtUserName" runat="server" CssClass="input normal" ReadOnly="true" /></dd>
            </dl>
            <dl>
                <dt>旧登录密码</dt>
                <dd>
                    <asp:TextBox ID="txtOldPassword" runat="server" CssClass="input normal" TextMode="Password" datatype="*6-20" nullmsg="请输入旧密码" errormsg="密码范围在6-20位之间" sucmsg=" "></asp:TextBox>
