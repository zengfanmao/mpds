...
namespace VIMS.LiveVideoSDK.Core
{
    ...
    {
        //domainname
        public const string MQQT_BROKER_DEFAULT_DOMAINNAME = "aimissu.xicp.net";

        public const string MQQT_BROKER_DEFAULT_IP = "127.0.0.1";
        public static int MQTT_BROKER_DEFAULT_PORT = Convert.ToInt32(ConfigurationManager.AppSettings["LiveVideoSDK_IM_port"]);//内网
        //public static int MQTT_BROKER_DEFAULT_PORT = 1883;//内网
        // default port for MQTT protocol
        //public const int MQTT_BROKER_DEFAULT_PORT = 33797;//外网
