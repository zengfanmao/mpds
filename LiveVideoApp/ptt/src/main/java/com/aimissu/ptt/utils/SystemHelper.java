...
public class SystemHelper {
    ...
    private static String tag="SystemHelper";
    /**
    ...
    public static void setTopApp(Context context) {
        if (!isRunningForeground(context)) {
            ...
            for (ActivityManager.RunningTaskInfo taskInfo : taskInfoList) {
                LogUtil.i(tag,"在遍历任务····taskInfo.baseActivity.getPackageName():"+taskInfo.baseActivity.getPackageName()+" context.getPackageName():"+context.getPackageName());
