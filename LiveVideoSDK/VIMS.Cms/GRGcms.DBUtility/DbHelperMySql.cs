...
namespace GRGcms.DBUtility
{
    ...
    public abstract class DbHelperMySql
    {
        ...
        public static string connectionString =
            ConfigurationManager.ConnectionStrings["ConnectionStringMysql"].ConnectionString;
        ...
        {
            var strsql = "select " + FieldName + " from " + TableName + " order by " + FieldName + " desc limit 1";
        ...
        private static MySqlCommand BuildIntCommand(MySqlConnection connection, string storedProcName,
            IDataParameter[] parameters)
        {
            MySqlCommand command = BuildQueryCommand(connection, storedProcName, parameters);
