<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sys_config.aspx.cs" Inherits="GRGcms.Web.admin.settings.sys_config" ValidateRequest="false" %>
        ...
        <div class="tab-content" style="display: none">
            <dl>
                ...
                <dd>
                    ...
                    <span class="Validform_checktip">尚未申请？<a href="http://www.GRGcms.net" target="_blank">请点击这里注册</a></span>
                </dd>
            </dl>
            <dl>
                <dt>短信API地址</dt>
            ...
            <dl>
                ...
                <dd>请不要使用系统默认账户test，因为它是公用的测试账号；<br />
                    ...
                    如果您尚未申请开通，<a href="http://www.GRGcms.net" target="_blank">请点击这里注册</a>成功后填写您的用户名和通讯密钥均可正常使用。
                </dd>
            </dl>
        </div>
        <!--/手机短信设置-->
