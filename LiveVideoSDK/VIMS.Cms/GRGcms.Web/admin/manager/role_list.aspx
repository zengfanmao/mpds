<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="role_list.aspx.cs" Inherits="GRGcms.Web.admin.manager.role_list" ValidateRequest="false" %>
                ...
                <div class="box-wrap">
                    ...
                    <div class="l-list">
                        <ul class="icon-list">
                            ...
                            <li>
                                <asp:LinkButton ID="btnDelete" runat="server" OnClientClick="return ExePostBack('btnDelete','本操作会删除角色及相关权限，是否继续？');" OnClick="btnDelete_Click"><i class="iconfont icon-delete"></i><span>删除</span></asp:LinkButton></li>
                        </ul>
                    </div>
                    <div class="r-list">
                ...
                <HeaderTemplate>
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="ltable">
                        <tr>
                            ...
                            <th align="left" width="12%">角色级别</th>
                            <th align="left" width="25%">角色描述</th>
