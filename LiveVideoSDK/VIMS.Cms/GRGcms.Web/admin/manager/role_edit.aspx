<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="role_edit.aspx.cs" Inherits="GRGcms.Web.admin.manager.role_edit" ValidateRequest="false" %>
...
<div class="tab-content">
  ...
  <dl>
    <dt>角色描述</dt>
    <dd><asp:TextBox ID="txtRoleMemo" runat="server" CssClass="input normal" datatype="*1-100" sucmsg=" "></asp:TextBox> <span class="Validform_checktip">*角色描述，100字符内</span></dd>
  </dl> 
      <dl>
    <dt>角色级别</dt>
    <dd>
      <asp:TextBox ID="txtRoleLevel" runat="server" CssClass="input small" datatype="n" sucmsg=" ">1</asp:TextBox>
