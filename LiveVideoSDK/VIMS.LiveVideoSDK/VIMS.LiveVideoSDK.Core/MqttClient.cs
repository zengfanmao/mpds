...
using VIMS.LiveVideoSDK.Core.Exceptions;
using VIMS.LiveVideoSDK.Core.Messages;
using VIMS.LiveVideoSDK.Core.Session;
using VIMS.LiveVideoSDK.Core.Utility;
using VIMS.LiveVideoSDK.Core.Internal;
...
// (it's ambiguos with VIMS.LiveVideoSDK.Core.Utility.Trace)
using MqttUtility = VIMS.LiveVideoSDK.Core.Utility;
using System.Net.Security;

namespace VIMS.LiveVideoSDK.Core
{
    /// <summary>
    /// MQTT Client
    /// </summary>
    public class MqttClient
    {
        ...
        {
            return this.Connect(clientId, null, null, false, MqttMsgConnect.QOS_LEVEL_EXACTLY_ONCE, false, null, null, true, MqttMsgConnect.KEEP_ALIVE_PERIOD_DEFAULT);
        }
        ...
        {
            return this.Publish(topic, message, MqttMsgBase.QOS_LEVEL_EXACTLY_ONCE, false);
        }
        ...
        internal class MqttMsgContextFinder
        {
            ...
            internal bool Find(object item)
            {
                ...
                return ((msgCtx.Message.Type == MqttMsgBase.MQTT_MSG_PUBLISH_TYPE) &&
                        (msgCtx.Message.MessageId.Equals(this.MessageId)) &&
