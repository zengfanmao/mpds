<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="group_select.aspx.cs" Inherits="GRGcms.Web.admin.manager.group_select" ValidateRequest="false" %>
            ...
            save: function () {
                ...
                if (groups.length > 0) {
                    $.ajax({
                        ...
                        type: 'GET', //GET                       
                        data: {
                            action:"group_add",ucode: ucode, groups: groups.join(",")
                        },
                        timeout: 5000,    //超时时间
